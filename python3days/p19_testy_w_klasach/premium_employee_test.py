...
# Teraz dla obiektu PremiumEmployee - jak go tworzymy w detup_method - zostaná wykonane takæe p19_testy odziedziczone z TestEmployee
# - czyli p19_testy zgodności z kontraktem klasy Employee
